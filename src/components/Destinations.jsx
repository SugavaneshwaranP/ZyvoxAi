...
const Destinations = () => {
    ...
    return (
        <section
            id="destinations"
            ref={sectionRef}
            className="w-full min-h-screen bg-[#7c3aed] relative overflow-hidden flex flex-col justify-center py-16 md:py-24 px-4 md:px-10 lg:px-20"
        >
            ...
            <div ref={contentRef} className="relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-20 items-center max-w-7xl mx-auto w-full">
                {/* Left Content */}
                <div className="flex flex-col items-start space-y-6 md:space-y-12">
                    ...
                    <h2 className="text-white text-3xl md:text-4xl lg:text-6xl font-black uppercase tracking-tighter leading-[0.9]">
                ...
                <div className="relative h-[300px] md:h-[450px] lg:h-[600px] overflow-hidden flex items-center justify-center">
                    <div className="dest-cards-container flex flex-col gap-8 py-20">
                        {[
                            ...
                            <div key={i} className="dest-card relative w-[clamp(220px,70vw,400px)] aspect-[4/3] bg-black border-[3px] md:border-[4px] border-black rounded-2xl md:rounded-3xl overflow-hidden shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] md:shadow-[12px_12px_0px_0px_rgba(0,0,0,1)] group hover:-translate-y-2 hover:-translate-x-2 hover:shadow-[12px_12px_0px_0px_rgba(0,0,0,1)] md:hover:shadow-[20px_20px_0px_0px_rgba(0,0,0,1)] transition-all duration-300">
                                ...
                                <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-transparent to-transparent flex flex-col justify-end p-4 md:p-6">
                                    <span className="text-white font-black text-lg md:text-2xl uppercase tracking-tighter italic">{dest.name}</span>
